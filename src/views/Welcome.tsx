    ...
    return (
        <div style={{ position: 'relative', width: '100vw', height: '100vh', overflow: 'auto', paddingBottom: '25px'}}>
            ...
            <div className='navbar-div'>
                <NavBar title={isMobile ? "Wally's World" : "Welcome to Wally's World"}/>
            </div>
            <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', width: '100%', marginTop: '80px', overflow: 'scroll', height:'80%'}}>
                ...
                <div style={pageStyle}>   
                    <div style={{ border:'1px solid #d3d3d3', borderRadius: '4px', padding: '5px'}}>
                        ...
                        <ul style={{ listStyleType: 'none', padding: '0', textAlign: 'left' }}>
                            ...
                            <li><strong>Degree:</strong> Bachelor of Science in <span style={{ fontWeight: 'bold',color: '#22bcf3' }}>Finance</span></li>
                            <li><strong>Other Interests:</strong> <span style={{ fontWeight: 'bold',color: '#22bcf3' }}>Computer Science</span> since June 2021</li>
                            {/* <a className='hover-underline' href="https://chat.openai.com/g/g-cN5P2jtNn-senior-technology-guide" target="_blank" rel="noopener noreferrer">
                                ChatGPT Store Project: Senior Technology Guide
                            </a> */}
                        </ul>
                    ...
                    <Link className='hover-underline' style={{marginTop: '50px', marginBottom: '15px'}} to="/resume"><strong style={{fontSize: isMobile ? '1.1em' : '1.3em', textDecoration: isMobile ? 'underline': ''}}>📄 Resume:</strong> Education & Professional Work Experience</Link>
                    <Link className='hover-underline' style={{marginBottom: '15px'}} to="/mycode"><strong style={{fontSize: isMobile ? '1.1em' : '1.3em', textDecoration: isMobile ? 'underline': ''}}>💻 My Code:</strong> What I Have Built</Link>
                    <Link className='hover-underline' style={{marginBottom: '15px',}} to="/wallergpt"><strong style={{fontSize: isMobile ? '1.1em' : '1.3em', textDecoration: isMobile ? 'underline': ''}}>🤖 WallerGPT:</strong> My AI Clone (In Progress)</Link>
                    <Link className='hover-underline' style={{marginBottom: '15px'}}to="/youtube"><strong style={{fontSize: isMobile ? '1.1em' : '1.3em', textDecoration: isMobile ? 'underline': ''}}>🚀 Anding Analytics - YouTube:</strong> My YouTube Channel</Link>
